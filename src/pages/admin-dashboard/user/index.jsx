            ...
            {withdrawals.map((withdrawal, index) => (
              <tr key={index} className="border-t border-gray-200">
                ...
                <td className="py-4 px-4">
                  <img src={withdrawal.image} alt="User" className="w-10 h-10 rounded-full" />
                </td>
                <td className="py-4 px-4 text-gray-700">
                  <p className="font-medium">{withdrawal.method}</p>
                  <p className="text-sm text-gray-500">User ID: {withdrawal.userId}</p>
                </td>
                <td className="py-4 px-4 text-gray-700">
                ...
                <td className="py-4 px-4 text-gray-700">{withdrawal.registered}</td>
                <td className="py-4 px-4 text-gray-700">{withdrawal.featured}</td>
                <td className="py-4 px-4 text-gray-700">{withdrawal.verified}</td>
              </tr>
            ))}
          </tbody>
        </table>
