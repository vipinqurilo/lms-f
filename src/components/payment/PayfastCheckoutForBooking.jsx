...
/**
 * PayfastCheckoutForBooking - A specialized component for handling PayFast checkouts for bookings
 * This component handles the booking payment workflow specifically, with optimizations to prevent multiple API calls
 */
const PayfastCheckoutForBooking = ({
  paymentUrl,
  setPaymentModal,
  onClose = () => {},
}) => {
  ...
  const renderModalContent = () => {
    ...
    } else if (isProcessingPayment || isLoading?.createBookingAsync) {
...
export default PayfastCheckoutForBooking; 