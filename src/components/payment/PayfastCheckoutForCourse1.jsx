...
const PayfastCheckoutForCourse1 = ({
          ...
          const countdownInterval = setInterval(() => {
            setCountdown((prev) => {
              ...
              if (prev <= 1) {
                ...
                const courseId =
                  response.data?.course?._id || response.data?._id;
                if (courseId) {
    ...
    if (
      ...
      if (payfastWindowRef.current) {
        windowCheckIntervalRef.current = setInterval(() => {
          try {
            if (
              payfastWindowRef.current.closed &&
              !paymentComplete &&
              !isProcessingPayment &&
              !paymentFailed
            ) {
    ...
    return (
      <div className="bg-white rounded-lg p-8 mt-4 w-3/4 max-w-xl text-center relative">
        ...
        <div className="flex flex-col items-center justify-center py-12">
          <div className="mb-6">
            <Loader text="Loading..." color="text-secondary" isBig={true} />
          </div>
              ...
              <div className="flex justify-between text-sm text-gray-600">
                ...
                <span className="font-medium">
                  {paymentDetails?.orderDate
                    ? new Date(paymentDetails.orderDate).toLocaleDateString()
        ...
        <div className="py-8">
          ...
          {popupBlocked ? (
            ...
            <div className="mb-4">
              ...
              <p>
                Click below if you want to reopen it and continue with payment.
              </p>
            </div>
          ) : (
  ...
  return <BackgroundModal PropComponent={() => renderModalContent()} />;
};
