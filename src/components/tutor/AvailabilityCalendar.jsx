...
const AvailabilityCalendar = ({ setIsAvailableModelOpen }) => {
  ...
  return (
    <div className=" h-full bg-white border rounded-lg w-[80%] mx-auto">
      <div
      ...
      <div
        ...
        className="h-[calc(100%-60.8px)] overflow-x-auto"
      >
