    ...
    <div className="col-span-1">
      ...
      <div className="w-full flex items-center gap-2">
        ...
        <button
          ...
          className="w-10 h-10 flex items-center justify-center border border-black/10 rounded-lg hover:bg-secondary/5"
        >
          <svg
            className="w-6 h-6 text-secondary hover:text-primary cursor-pointer"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
