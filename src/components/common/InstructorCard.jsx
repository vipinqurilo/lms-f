...
export default function InstructorCard({ data }) {
  return (
    <div className="relative flex flex-col rounded-xl bg-white shadow-md overflow-hidden group">
      {/* Image Container with Background */}
      <div className="relative flex items-center justify-center h-60 bg-gray-200 overflow-hidden">
        <Image
      ...
      <div className="p-4 lg:px-2 ">
        <h2 className="mb-1 text-2xl font-semibold text-blue-gray-900">
            ...
            <div className="flex items-start gap-2 text-gray-700">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                {data?.subjectsTaught?.slice(0, 2).map((subject) => (
                  <p
                    key={subject?._id}
                    className="px-3 py-1 text-sm font-medium bg-secondary/5 rounded-md "
                  >
