...
const PayoutSettings = () => {
  ...
  const settings = useSelector(selectPayoutSettings);
  ...
  const isLoading = loading.getPayoutSettings;
  const isUpdating = loading.updatePayoutSettings;

  return (
    <div className="bg-white p-6 rounded-lg shadow">
      {isLoading ? (
        <div className="min-h-[400px] flex items-center justify-center">
          <Loader text="Loading payout settings..." color="text-primary" />
        </div>
      ) : (
        <>
          {/* Payment Method Tabs */}
