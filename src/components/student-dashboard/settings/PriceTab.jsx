...
const PriceTab = () => {
  ...
  return (
    <div className=" mx-auto p-6 space-y-6">
      ...
      >
        Note: Prices Are Managed By Admin And In Base Currency [R]
      </div>
      ...
      <button
        ...
        className="w-fit flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-secondary hover:bg-secondary ring-[1px] ring-gray-200 outline-none focus:ring-2 focus:ring-offset-2 focus:ring-secondary disabled:opacity-60 disabled:cursor-not-allowed"
        disabled={loading}
      >
