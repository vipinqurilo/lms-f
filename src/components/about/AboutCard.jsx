...
const AboutCard = ({ data, index }) => {
  return (
    <div className="w-full grid grid-cols-1 md:grid-cols-1 lg:flex lg:items-center gap-14">
      <div
        className={`w-full h-[40vh] lg:h-[60vh] rounded-xl bg-no-repeat bg-center bg-cover flex items-end justify-center ${index % 2 !== 0 && "lg:order-2 lg:!col-span-2"}`}
        style={{
      ...
      <div className="w-full lg:col-span-3 flex flex-col items-start gap-4">
