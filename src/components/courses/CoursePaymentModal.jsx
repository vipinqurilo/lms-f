    ...
    <div className="lg:grid grid-cols-2 gap-8 p-8 font-nunito">
      <div>
        ...
        <div className="space-y-2">
          {paymentMethods.map((method) => (
            ...
            >
              <span
                className={`text-white rounded-full p-[2px] ${
                  selected === method.id ? "bg-secondary" : "bg-[#E6E6E6]"
                }`}
              >
                <Check size={16} />
              </span>
      ...
      <div>
        ...
        <div className="flex gap-2 relative">
          ...
          <div
            onClick={applyCoupon}
            className="px-4 flex justify-center rounded-lg cursor-pointer items-center absolute right-5 h-[32px] text-sm top-[50%] -translate-y-[50%] bg-black text-white hover:bg-secondary"
          >
            Apply
          </div>
        </div>
