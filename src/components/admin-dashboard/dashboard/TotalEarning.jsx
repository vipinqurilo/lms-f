  ...
  return (
    <div>
      <div className="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
        <h5 className="text-xl text-black font-bold">Total Earnings</h5>
        <div className="my-8">
          <h1 className="text-3xl border-b border-gray-300 pb-4 font-bold text-gray-800">$ 879,940</h1>
          <span className="text-gray-500 pt-4">Compared to last week $13,988</span>
        </div>
        <svg
          className="w-full"
          viewBox="0 0 218 69"
