...
// const columns = [
//   "ID", "Image", "Name/ID", "Email/Phone", "Type", "Registered", "Verified", "Status", "Action"
// ];

// const UsersHistory = () => {
//   const dispatch = useDispatch();
//   const { users, total, isLoading } = useSelector((state) => state.admin.user);
...
//   useEffect(() => {
//     dispatch(getAllUsers({ ...filters, page: currentPage, limit: itemsPerPage }));
...
const UsersHistory = () => {
  ...
  useEffect(() => {
    dispatch(getAllUsers({ page, limit: 5, ...filters })); // Fetch new data on page change and apply filters
