...
const TeachersTable = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getAllTeachers({ ...data, page, limit: 5 }));
  }, [filtersData, page]);
  ...
  useEffect(() => {
    dispatch(getAllTeachers({ page, limit: 5 })); // Set the limit as needed
  }, [dispatch, page]);
