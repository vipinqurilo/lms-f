    ...
    return [  
      {
        ...
        // destination: "https://stretchr-terrorist-yarn-trail.trycloudflare.com/api/:path*", // Use local backend for testing PayFast
        // destination: "https://native-explorer-juan-signature.trycloudflare.com/api/:path*", // Use local backend for testing PayFast
      },
    ];
  },
};  
